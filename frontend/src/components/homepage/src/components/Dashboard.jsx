        ...
        <div className="row" {...provided.droppableProps} ref={provided.innerRef}>
          <div className="col-lg-3 col-6">
            ...
            <Draggable key="{id}" draggableid="{id}" index="{index}">
              {(provided) => (
            <div className="small-box bg-info" {...provided.draggable} {...provided.dragHandleProps}ref={provided.innerRef}>
              <div className="inner">
                <h3>150</h3>
                <p>New Orders</p>
              </div>
          ...
          <div className="col-lg-3 col-6">
            ...
            <Draggable key="{id}" draggableid="{id}" index="{index}">
              {(provided) => (
            <div className="small-box bg-success" {...provided.draggable} {...provided.dragHandleProps}ref={provided.innerRef}>
              <div className="inner">
          ...
          <div className="col-lg-3 col-6">
            ...
            <Draggable key="{id}" draggableid="{id}" index="{index}">
              {(provided) => (
            <div className="small-box bg-warning" {...provided.draggable} {...provided.dragHandleProps}ref={provided.innerRef}>
              <div className="inner">
                <h3>44</h3>
          ...
          <div className="col-lg-3 col-6">
            ...
            <Draggable key="{id}" draggableid="{id}" index="{index}">
              {(provided) => (
            <div className="small-box bg-danger"{...provided.draggable} {...provided.dragHandleProps}ref={provided.innerRef}>
              <div className="inner">
                <h3>65</h3>
                <p>Unique Visitors</p>
              </div>
